...
ArrayList <Nota> notas = new ArrayList <Nota>(8);
	...
	public Nota getExamen1() {
		return notas.get(0);
	}

	public Nota getExamen2() {
		return notas.get(1);
	}

	public Nota getExamen3() {
		return notas.get(2);
	}

	public Nota getExamen4() {
		return notas.get(3);
	}

	public Nota getExamen5() {
		return notas.get(4);
	}
